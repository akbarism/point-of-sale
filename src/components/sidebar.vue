<template>
  <div class="side">
    ...
    <div class="add">
      <img @click="$refs.addmenu.show()" src="../assets/img/add.png" alt />
    </div>
    <div class="logout" @click="logot">
      <i class="fas fa-sign-out-alt fa-2x text-red-600"></i>
    </div>
    <t-modal class="flex flex-col justify-center" ref="addmenu">
      ...
      <div class="form-add">
        ...
        <form @submit.prevent="add">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" v-model="menuValue.name" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-price" id="price" v-model="menuValue.price" />
          </div>
          <div class="form-group">
            <label class="label" for="catgeory">Category</label>
            <select type="select" class="form-select" id="category" v-model="menuValue.id_category">
